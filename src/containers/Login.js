...
export default class Login {
    ...
    handleSubmitAdmin = (e) => {
        ...
        const user = {
            type: "Admin",
            // email: e.target.querySelector(`input[data-testid="employee-email-input"]`).value, // Old version
            // password: e.target.querySelector(`input[data-testid="employee-password-input"]`).value, // Old version
            email: e.target.querySelector(
